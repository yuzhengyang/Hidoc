...
import com.yuzhyn.hidoc.app.application.customization.entity.*;
import com.yuzhyn.hidoc.app.application.customization.mapper.*;
...
public class DocController {
    ...
    /**
     * 文档数据迁移：需要替换文档中图片的链接地址
     * UPDATE asd SET content = REPLACE(content, 'http://192.168.3.1:24001/i/f/d/u/', 'http://192.168.3.44:24001/i/f/d/u/');
     */
}
