    ...
    <div v-if="pageMode === 'detail'">
        ...
        <div style="position: fixed; bottom: 50px; right: 30px">
            <el-badge :value="this.commentCount" class="item" :hidden="this.commentCount == 0">
                <el-button icon="el-icon-chat-dot-square" circle @click="this.scrollToBlock('comment')"></el-button>
            </el-badge>
        </div>
        ...
        <div style="position: fixed; bottom: 150px; right: 30px">
            <el-button icon="el-icon-caret-top" circle @click="this.scrollToBlock('top')"></el-button>
        </div>
        <!-- ========== ========== ========== 右侧快捷按钮：工具条 ========== ========== ==========  -->
        <!-- z-index: 9999;  -->
        <div style="position: fixed; top: 100px; right: 30px" v-if="this.$store.state.user.token != undefined && this.$store.state.user.token != ''">
